...
namespace AVCli.AVLib.Tests.Extractor
{
    ...
    public class JavDBExtractorTest
    {
        ...
        public void Init()
        {
            ...
            var pathSearch = Path.Combine(Directory.GetCurrentDirectory(), "Test\\JAVDB\\SearchIndex.html");
            var searchContent = File.ReadAllText(pathSearch);
        ...
        public async Task MyTestMethod()
        {
            ...
            var url = await extractor.getDetailPageUrl("MUM-120");
        }
    }
}
